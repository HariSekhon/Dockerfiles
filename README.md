...
- [Jenkins Agent with Docker](https://www.jenkins.io/) - Jenkins inbound-agent with docker installed - [readme](https://github.com/HariSekhon/Dockerfiles/blob/master/jenkins-docker/README-jenkins-docker.md)
