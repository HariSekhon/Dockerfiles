...
LABEL org.opencontainers.image.description="Fedora + my GitHub repos pre-built" \
      org.opencontainers.image.authors="Hari Sekhon (https://www.linkedin.com/in/HariSekhon)" \
      org.opencontainers.image.url="https://ghcr.io/HariSekhon/fedora-github" \
      org.opencontainers.image.documentation="https://hub.docker.com/r/harisekhon/fedora-github" \
