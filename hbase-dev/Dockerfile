...
LABEL org.opencontainers.image.description="HBase Dev" \
      org.opencontainers.image.version="$HBASE_VERSION" \
      org.opencontainers.image.authors="Hari Sekhon (https://www.linkedin.com/in/HariSekhon)" \
      org.opencontainers.image.url="https://ghcr.io/HariSekhon/hbase-dev" \
      org.opencontainers.image.documentation="https://hub.docker.com/r/harisekhon/hbase-dev" \
...
RUN set -eux && \
    ...
    # HBase 0.99 / 1.0
    elif [ "${HBASE_VERSION:0:4}" = "0.99" ] || [ "${HBASE_VERSION:0:3}" = "1.0" ]; then \
