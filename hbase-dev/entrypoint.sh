...
/hbase/bin/start-hbase.sh | grep -v "ssh: command not found"
/hbase/bin/hbase-daemon.sh start rest
/hbase/bin/hbase-daemon.sh start thrift
#/hbase/bin/hbase-daemon.sh start thrift2
/hbase/bin/hbase shell
echo -e "\n\nShutdown avoided by default EOF to avoid confusion for people not running this image in interactive mode, see https://github.com/harisekhon/Dockerfiles/issues/2"
