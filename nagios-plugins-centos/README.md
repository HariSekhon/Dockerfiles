...
This docker image contains all dependencies pre-built on CentOS and is tagged `harisekhon/nagios-plugins:centos`. For variants on Alpine, Debian and Ubuntusee see adjacent directories.
