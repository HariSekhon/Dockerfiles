...
This docker image contains all dependencies pre-built on Ubuntu and is tagged `harisekhon/nagios-plugins:ubuntu`. For variants on Alpine, Debian and CentOS see adjacent directories.
