...
LABEL org.opencontainers.image.description="ZooKeeper Dev" \
      org.opencontainers.image.version="$ZOOKEEPER_VERSION" \
      org.opencontainers.image.authors="Hari Sekhon (https://www.linkedin.com/in/HariSekhon)" \
      org.opencontainers.image.url="https://ghcr.io/HariSekhon/zookeeper-dev" \
      org.opencontainers.image.documentation="https://hub.docker.com/r/harisekhon/zookeeper-dev" \
